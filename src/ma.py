...
if __name__ == '__main__':
    ...
    model = RLAgent(int(num_wheelchairs), int(38/2), int(4), critic_units=[1024, 512, 256, 128, 64, 32, 16, 8, 4], 
                    actor_units=[512,256,128,64,32,16,8], lr_actor=1e-2, lr_critic=1e-1)
